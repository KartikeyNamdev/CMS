      ...
      <div className="bg-background/95 backdrop-blur-2xl p-4 border-b border-gray-300">
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            <label className="block text-lg text-gray-700 mb-1">Latitude</label>
            <input
              type="text"
              value={latInput}
              onChange={(e) => setLatInput(e.target.value)}
              className="w-full px-3 py-2 bg-black/10 border border-gray-300 rounded text-black text-sm focus:outline-none focus:border-red-500"
