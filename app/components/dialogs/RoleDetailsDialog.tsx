  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent
        ...
        style={{ maxWidth: "800px", height: "800px" }} // Optional: Enforce specific large size for better visibility
      >
        {/* HEADER */}
        <DialogHeader className="sticky top-0 bg-white z-10 border-b px-6 py-4">
          <DialogTitle className="text-2xl font-semibold bg-white/80">
            View Custom Role
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="rounded-xl border bg-white">
            {data.permissions?.map((section: any, i: number) => (
