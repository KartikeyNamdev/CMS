...
const initialChargers: Charger[] = [
  {
    id: "charger-1",
    stationId: "station-a",
    chargerName: "Aryan DC Fast Charger",
    stationName: "Aryan Hotel Station",
    ocppId: "OCPP-ARYAN-001",
    oem: "Exicom",
    chargerType: "DC",
    powerRating: "60kW",
    chargerPowerRating: "60kW",
    ...
    pincode: "302020",
    street: "Jaipur Road",
    stationSiteId: "SITE-ARY-001",
    zone: "North",
    // Access & Timing
    openingTime: "00:00",
    closingTime: "23:59",
    accessType: "Public",
    alternativeAccessType: "Semi-Public",
    // Deal Details
    fixedCostPerKwh: 8.5,
    electricityConnectionOwnedBy: "Aryan Hotel Group",
    electricityConnectionType: "Commercial",
    meterType: "Smart Meter",
    discomIdAccountNumber: "JVVNL-123456",
    estimatedElectricityChargePerKwh: 6.5,
    insuranceAmountAnnual: 50000,
    // Financial Details
    dateOfCompanyMapping: "2024-01-15",
    fixedFee: 1000,
    saas: 500,
    profitShare: 15,
    revenueShare: 20,
    dealApplicable: "Standard CPO Deal",
  },
  {
    id: "charger-2",
    stationId: "station-a",
    chargerName: "Aryan AC Slow Charger",
    stationName: "Aryan Hotel Station",
    ocppId: "OCPP-ARYAN-002",
    oem: "Servotech",
    chargerType: "AC",
    powerRating: "7.4kW",
    chargerPowerRating: "7.4kW",
    operationalStatus: "Active",
    firmware: "4.0.3",
    label: "Slow Charger",
    discountOffer: 0,
